...
var globalCharts = function(scope, element){   
    ...
    scope.globalRenderBars = function(globalData, classe) {
...
scope.globalRenderResumeNodes=function(data){
...
scope.globalRenderTransitionNodes=function(data){
    ...
    function resize(){
      if(typeof scope.data ==='undefined') return;
          ...
          /*  else if(scope.d3opts.issueCode in {'recoveries':''})
                scope.globalRenderResumeNodes(scope.data, scope.d3opts.issueCode)
              else
